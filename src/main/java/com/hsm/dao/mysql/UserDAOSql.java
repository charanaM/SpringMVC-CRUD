...
package com.hsm.dao.mysql;

import com.hsm.dao.UserDAO;
import com.hsm.map.UserMapper;
...
public class UserDAOSql implements UserDAO {
    ...
    public void addUser(User user) {
        String insertUserQuery = "INSERT INTO user_info (name, age, address, username, password) VALUES (?, ?, ?, ?, ?)";
        jdbcTemplate.update(insertUserQuery, user.getName(), user.getAge(), user.getAddress(), user.getUsername(), user.getPassword());
